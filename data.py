...
class Poet(data.Dataset):
    def __init__(self, type='train', seed=1):
        errIndex = [6240, 7802, 12280, 24700, 26395, 31326, 38520, 40163, 50285, 53447, 70357, 70420, 70496, 70590,
                    ...
                    109034, 109357, 109845, 109914, 109984, 110083, 110085, 110106, 110119, 110355, 110745, 134157,
                    134252, 134436, 137556, 138876, 146343, 149505, 152865, 155178, 163492, 166584, 166593, 179122,
                    179603, 179669, 179698, 197369, 197739, 197743, 197771, 197802, 200813, 201415, 211829, 222786,
                    225349, 230059, 234159, 234634, 240251, 251118, 251818, 255825, 255917, 257192, 263377, 263385,
                    263912, 263976, 263987, 264959, 273967, 279885, 280377, 286757, 287437, 288109, 288155, 302762,
                    310070, 310072, 310074, 310076, 310078, 310080, 310082, 310084, 310086, 310088, 310090, 310092,
                    310094, 310096, 310098, 310100, 310102, 310104, 310106, 310108]  # 遺漏值索引
        self.npz = np.delete(np.load('data/poet.npz')['poetry'], errIndex, axis=0)
        ...
        if type == 'train':
            myMap = lambda x: x[:int(0.6 * self.npz.shape[0]), 1]
